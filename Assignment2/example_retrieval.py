...
def gen_stage_0(
    corpus, queries, rank_model_name, rerank, rerank_model_name, output_name
):
    ...
    if rerank:
        ...
        rerank_postprocessors = FlagEmbeddingReranker(
            model=rerank_model_name, top_n=topk
        )
...
if __name__ == "__main__":
    ...
    # On macOS, ru_maxrss is typically reported in kilobytes.
    # Convert to MiB for easier readability:
    # peak_memory_mib = peak_memory_kb / 1024
