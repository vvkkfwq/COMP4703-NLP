"""
sentence-transformers/all-MiniLM-L6-v2 ranker + bge-reranker-base reranker
"""
...
def start_retrival(corpus, queries, rank_model_name, rerank_model_name, output_name):
...
if __name__ == "__main__":
    ...
    if STAGING:
        output_name = "output/staging/rerankerB.json"
    else:
        output_name = "output/production/rerankerB.json"
